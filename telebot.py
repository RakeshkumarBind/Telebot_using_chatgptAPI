...
async def welcome(message: types.Message):
    ...
    """
    clear_past()
    await message.reply("Hello! \nI'm a chatGPT Telegram bot created by RAKESHKUMAR PRABHURAM BIND .\n How can I assist you?")
...
async def helper(message: types.Message):
    ...
    """
    help_command = """
    Hi There, I'm chatGPT Telegram bot created by Rakeshkumar Prabhuram Bind! Please follow these commands - 
